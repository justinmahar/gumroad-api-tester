...
exports.v2Api = [
    ...
    },
    {
        endpointUrl: '/resource_subscriptions',
        method: 'PUT',
        description: 'Subscribe to a resource. Currently there are 8 supported resource names - "sale", "refund", "dispute", "dispute_won", "cancellation", "subscription_updated", "subscription_ended", and "subscription_restarted".',
        params: [
